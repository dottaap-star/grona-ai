            ...
            <div className="mx-auto max-w-container px-4 md:px-8">
                <div className="flex flex-col gap-12 md:gap-16">
                    <div className="flex w-full flex-col items-center self-center text-center md:max-w-3xl">
                        ...
                        <h2 className="mt-4 text-display-sm font-semibold text-primary md:mt-6 md:text-display-md">Results that speak for themselves</h2>
                        <p className="mt-4 text-lg text-tertiary md:mt-5 md:text-xl">From Grona-powered experiments on real sites.</p>
                    </div>

                    <dl className="flex w-full flex-col justify-center gap-8 md:max-w-4xl md:flex-row md:gap-4 md:self-center">
                        {[
                            { title: "Up to 40%", subtitle: "Conversion lift" },
                            { title: "5 min", subtitle: "To live A/B test" },
                            { title: "Zero", subtitle: "Code required" },
                            { title: "Any", subtitle: "CMS supported" },
                        ].map((item, index) => (
