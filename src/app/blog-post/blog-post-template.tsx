                ...
                <div className="mx-auto flex justify-center gap-16">
                    ...
                    <div className="max-w-prose md:max-w-180">
                        <div className="mx-auto prose md:prose-lg">
                            ...
                            <figure>
                                <Image className="h-60 md:h-120" src="https://www.untitledui.com/marketing/ai-woman-04.webp" alt="Woman working at computer" width={720} height={480} />
                                <figcaption>
                            ...
                            <figure>
                                <Image className="h-110 md:h-210" src="https://www.untitledui.com/marketing/smiling-girl-10.webp" alt="Smiling woman" width={840} height={840} />
                                <figcaption>
    ...
    <article className={cx("flex flex-col gap-4", className)}>
        <div className="relative">
            <a href={article.href} className="w-full" tabIndex={-1}>
                <Image src={article.thumbnailUrl} alt={article.title} width={600} height={400} className={cx("aspect-[1.5] w-full object-cover", imageClassName)} />
            </a>
