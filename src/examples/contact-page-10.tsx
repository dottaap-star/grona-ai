...
const ContactSectionSimpleForm05 = () => {
        ...
        <section className="grid min-h-screen grid-cols-1 bg-primary lg:grid-cols-[416px_1fr]">
            <div className="hidden bg-brand-section px-4 py-16 lg:block lg:p-12">
                <div className="mx-auto flex max-w-128 flex-col lg:h-full">
                    ...
                    <p className="mt-4 text-lg text-tertiary_on-brand">We' love to hear from you. Our friendly team is always here to chat.</p>
                        ...
                        {[
                            ...
                            <li key={item.title} className="flex gap-4">
                                ...
                                <div className="flex flex-col items-start">
                                    ...
                                    <p className="mt-1 text-md text-tertiary_on-brand md:mt-2">{item.subtitle}</p>
                    ...
                    <ul className="mt-12 flex gap-8 lg:mt-auto">
                        {[
                            ...
                            { title: "Dribbble", icon: Dribbble, href: "#" },
...
const ContactPage10 = () => {
    return (
        <div className="bg-primary">
            <ContactSectionSimpleForm05 />
        </div>
    );
};

export default ContactPage10;
