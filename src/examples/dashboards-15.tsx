...
const receipts = [
    ...
    },
    {
        ...
        fileSize: "220 KB",
        category: (
            <BadgeWithDot size="sm" type="pill-color" color="pink">
                Dining
            </BadgeWithDot>
        ),
        paymentMethod: {
        ...
        <div className="flex flex-col bg-primary lg:flex-row">
            ...
            <main className="flex min-w-0 flex-1 flex-col gap-8 pt-8 pb-12">
                ...
                <div className="flex flex-col gap-4 px-4 lg:px-8">
                    <div className="flex flex-col justify-between gap-4 border-secondary pb-1 lg:flex-row lg:border-b lg:pb-4">
                    ...
                    <Tabs selectedKey="overview" className="border-b border-secondary lg:hidden">
                        <TabList
                            type="underline"
                            items={[
                ...
                <div className="flex- flex gap-8 px-4 lg:px-8">
                    <div className="flex w-full flex-col gap-8 lg:w-87">
                        ...
                        <div className="relative flex h-75.5 w-full items-center justify-center rounded-2xl bg-quaternary md:rounded-[20px]">
                            ...
                            <div className="translate-y-3 -space-y-[179px] lg:-space-y-[183px]">
                                ...
                                >
                                    <CreditCard width={374} type="transparent-gradient" cardHolder="Lana Steiner" className="lg:hidden" />
                                ...
                                >
                                    <CreditCard width={374} type="brand-dark" cardHolder="Olivia Rhye" className="lg:hidden" />
                                    <CreditCard width={382} type="brand-dark" cardHolder="Olivia Rhye" className="max-lg:hidden" />
                                </div>
                                <div
                        ...
                        <div className="flex flex-col gap-6 lg:gap-5">
                            ...
                            <dl className="flex flex-col gap-4">
                                {[
                                    { id: "current-balance", label: "Current balance", value: "$1,440.40" },
                                    { id: "current-limit", label: "Current limit", value: "$15,000.00" },
                                    { id: "budget-this-month", label: "Budget this month", value: "$2,400.00" },
                                ].map((item) => (
                    ...
                    <div className="hidden min-w-0 flex-1 flex-col gap-8 lg:flex">
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="flex h-60 flex-col gap-1.5">
                                <ResponsiveContainer className="max-h-full">
                                    <AreaChart
                                        data={lineData}
                                        className="text-tertiary [&_.recharts-text]:text-xs"
                                        margin={{
                                            ...
                                            {(item) => (
                                                <Table.Row id={item.id}>
                                                    <Table.Cell className="w-full px-0">
                                                        <div className="flex items-center gap-3">
                                                            <FileIcon type={item.fileType} theme="light" className="size-10 dark:hidden" />
                                                            <FileIcon type={item.fileType} theme="dark" className="size-10 not-dark:hidden" />
                                                    ...
                                                    <Table.Cell className="max-xl:hidden">
                                                        <div className="flex items-center gap-3">
                                                            ...
                                                            <div className="flex flex-col">
                                                                <p className="text-sm font-medium text-nowrap text-primary">{item.paymentMethod.cardType}</p>
