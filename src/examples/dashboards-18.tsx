...
import { BarChartSquare02, CheckDone01, DownloadCloud02, FilterLines, HomeLine, PieChart03, Rows01, Users01 } from "@untitledui/icons";
...
export const Dashboard18 = () => {
    ...
    return (
        <div className="flex flex-col bg-primary lg:flex-row">
            ...
            />
            <main className="flex w-full min-w-0 flex-col gap-8 bg-secondary_subtle pt-8 pb-12 lg:gap-6">
                {/* Page header */}
                ...
                <div className="flex flex-col gap-5 px-4 md:flex-row md:flex-wrap lg:gap-6 lg:px-8">
                    <MetricsChart01 title="20.8k" subtitle="Users" change="12%" className="flex-1 md:min-w-[320px]" />
                    <MetricsChart01
                        title="26.4k"
                        subtitle="Sessions"
                        trend="negative"
                        change="2%"
                        chartData={sessionsMetricChartData}
                        className="flex-1 md:min-w-[320px]"
                    />
                    <MetricsChart01 title="3m 52s" subtitle="Session duration" change="2%" className="flex-1 md:min-w-[320px]" />
                </div>
