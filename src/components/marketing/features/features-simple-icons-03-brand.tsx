...
import { FeatureTextFeaturedIconTopLeftBrand } from "@/components/marketing/features/base-components/feature-text";
            ...
            <div className="mx-auto max-w-container px-4 md:px-8">
                ...
                <div className="mt-12 md:mt-16">
                    <ul className="grid w-full grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 md:gap-y-16 lg:grid-cols-3">
                        {features.map((item) => (
                            <li key={item.title}>
                                <FeatureTextFeaturedIconTopLeftBrand
                                    {...item}
                                    footer={
                                        <Button color="link-gray" size="lg" href={item.href} className="text-primary_on-brand" iconTrailing={ArrowRight}>
                                            {item.cta}
                                        </Button>
                                    }
                                />
