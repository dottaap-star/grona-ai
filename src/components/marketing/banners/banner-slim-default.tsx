...
export const BannerSlimDefault = () => {
    return (
        <div className="relative mx-2 mb-4 flex items-center gap-4 rounded-xl bg-secondary_subtle p-4 shadow-lg ring-1 ring-primary ring-inset md:m-0 md:gap-3 md:px-12 md:py-4">
